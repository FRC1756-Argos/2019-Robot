...
namespace OCInputs
{
  ...
  constexpr size_t  button_depot_idx = 1;
  ...
  constexpr uint8_t button_cargoShip_in = 42;
  constexpr uint8_t button_cargoShip_gnd = 43;
  ...
  constexpr uint8_t button_unassigned3_in = A0;
  constexpr uint8_t button_unassigned3_gnd = A1;
...
namespace OCOutputs
{
  ...
  constexpr bool    led_button_feeder_pwm = true;
  constexpr size_t  led_button_feeder_idx = 0;
  ...
  constexpr uint8_t led_button_cargoShip_out = 11;
  constexpr uint8_t led_button_cargoShip_gnd = NOT_A_PIN;
  constexpr bool    led_button_cargoShip_pwm = true;
  constexpr size_t  led_button_cargoShip_idx = 8;
  ...
  constexpr uint8_t led_switch_cargoHatch_Cargo_out = 0;
  ...
  constexpr uint8_t led_switch_leftRight_Left_out = 15;
  ...
  constexpr uint8_t led_switch_leftRight_Right_out = 23;
  ...
  constexpr uint8_t led_button_unassigned3_out = 26;
  constexpr uint8_t led_button_unassigned3_gnd = NOT_A_PIN;
  ...
  constexpr uint8_t led_switch_unassigned1_OFF_out = 28;
  ...
  constexpr uint8_t led_switch_unassigned1_ON_out = 29;
  ...
  constexpr uint8_t led_switch_unassigned2_OFF_out = 30;
  ...
  constexpr uint8_t led_switch_unassigned2_ON_out = 31;
